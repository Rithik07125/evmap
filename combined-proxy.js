...
const ION_FINGERPRINT = 'b8c9ecc9-c874-4205-9a44-a8fa25c8c15f';
const UAEV_BEARER_TOKEN = 'PASTE_YOUR_UAEV_BEARER_TOKEN_HERE';
const ZYNETIC_BEARER_TOKEN = 'PASTE_YOUR_ZYNETIC_BEARER_TOKEN_HERE';
const ZYNETIC_ORG_ID = 'org_r6t7OyT6gEOSjoeJQiRRSSH6AYCgWFDF';
// ======================================
...
http.createServer(async (req, res) => {
  ...
  if (req.url.startsWith('/ion')) {
    ...
    res.writeHead(404);
    res.end('Use /ion, /uaev or /e2go');
  }
}).listen(3001, () => {
  console.log('Combined proxy running on http://localhost:3001');
  console.log('  ION:    http://localhost:3001/ion');
  console.log('  UAEV:   http://localhost:3001/uaev');
  console.log('  E2GO:   http://localhost:3001/e2go');
  console.log('  Zynetic: http://localhost:3001/zynetic');
  console.log('  DEWA:   http://localhost:3001/dewa');
  console.log('Keep this window open while using the map.');
});
